--/////////////////////////////////////--
-- Advanced Weapon Framework - CQBR Stats
...
local CQBR = {
    ...
    DMG_LVL_01_INFO = "2.20",			--("2.20")
    DMG_LVL_01_COST = -1,				--(-1)
            
    DMG_LVL_02 = 1.15,					--(1.15)
    DMG_LVL_02_INFO = "2.30",			--("2.30")
    DMG_LVL_02_COST = 22000,			--(22000)
            
    DMG_LVL_03 = 1.30,					--(1.30)
    DMG_LVL_03_INFO = "2.60",			--("2.60")
    DMG_LVL_03_COST = 36000,			--(36000)
            
    DMG_LVL_04 = 1.50,					--(1.50)
    DMG_LVL_04_INFO = "3.00",			--("3.00")
    DMG_LVL_04_COST = 50000,			--(50000)
            
    DMG_LVL_05 = 1.70,					--(1.70)
    DMG_LVL_05_INFO = "3.40",			--("3.40")
    DMG_LVL_05_COST = 64000,			--(64000)
    --///WINCE///--
    WINC_LVL_01 = -1.0,					--(-1.0) Invalid don't change it. Change WPtype_BaseWINCE above instead.
    WINC_LVL_02 = 1.25,					--(1.25)
    ...
    AMMO_LVL_02 = 23,					--(23)
    AMMO_LVL_02_INFO = "23", 			--("23")
    AMMO_LVL_02_COST = 8000,			--(8000)
            
    AMMO_LVL_03 = 26,					--(26)
    AMMO_LVL_03_INFO = "26", 			--("26")
    AMMO_LVL_03_COST = 14000,			--(14000)
            
    AMMO_LVL_04 = 29,					--(29)
    AMMO_LVL_04_INFO = "29",			--("29")
    AMMO_LVL_04_COST = 20000,			--(20000)
            
    AMMO_LVL_05 = 32,					--(32)
    AMMO_LVL_05_INFO = "32",			--("32")
    AMMO_LVL_05_COST = 26000,			--(26000)
    ...
    RELOAD_LVL_02 = 1.12,				--(1.12)
    RELOAD_LVL_02_INFO = "0.95",		--("0.95")
    RELOAD_LVL_02_COST = 12000,			--(12000)
            
    RELOAD_LVL_03 = 1.25,				--(1.25)
    RELOAD_LVL_03_INFO = "1.05",		--("1.05")
    RELOAD_LVL_03_COST = 19000,			--(19000)
            
    RELOAD_LVL_04 = 1.37,				--(1.37)
    RELOAD_LVL_04_INFO = "1.15",		--("1.15")
    RELOAD_LVL_04_COST = 26000,			--(26000)
            
    RELOAD_LVL_05 = 1.49,				--(1.49)
    RELOAD_LVL_05_INFO = "1.25",		--("1.25")
    RELOAD_LVL_05_COST = 33000,			--(33000)
           
        --//////CQBR Limit Break Stats//////--
