...
local BT = {
    ...
    ItemSize = 7,					    --(8) The amount of space taken up by the item in the Attaché Case.
    ...
    ReloadSpeedRate = 1.2, 			    --(1.2) Base Reload Speed
    FireRate = 1.9,					    --(1.9) Base Rate of Fire
    ...
    Focus_HoldAdd = 80.0,			    --(80.0)
    Focus_MoveSub = 73.0,			    --(73.0)
    Focus_CamSub = 85.0,			    --(85.0)
    ...
    DMG_LVL_01_INFO = "1.40",			--("1.40")
    DMG_LVL_01_COST = -1,				--(-1)
            
    DMG_LVL_02 = 1.14,					--(1.14)
    DMG_LVL_02_INFO = "1.60",			--("1.60")
    DMG_LVL_02_COST = 14000,			--(14000)
            
    DMG_LVL_03 = 1.36,					--(1.36)
    DMG_LVL_03_INFO = "1.90",			--("1.90")
    DMG_LVL_03_COST = 28000,			--(28000)
            
    DMG_LVL_04 = 1.5,					--(1.50)
    DMG_LVL_04_INFO = "2.10",			--("2.10")
    DMG_LVL_04_COST = 40000,			--(40000)
            
    DMG_LVL_05 = 1.71,					--(1.71)
    DMG_LVL_05_INFO = "2.40",			--("2.40")
    DMG_LVL_05_COST = 59000,			--(59000)
    --///WINCE///--
    ...
    BRK_LVL_02 = 1.18,					--(1.18)
    BRK_LVL_03 = 1.37,					--(1.37)
    BRK_LVL_04 = 1.56,					--(1.56)
    BRK_LVL_05 = 1.75,					--(1.75)
    --///STOPPING POWER///--
    STOP_LVL_01 = -1.0,					--(-1.0) Invalid don't change it. Change WPtype_BaseSTOP above instead.
    STOP_LVL_02 = 1.18,					--(1.18)
    STOP_LVL_03 = 1.37,					--(1.37)
    STOP_LVL_04 = 1.56,					--(1.56)
    STOP_LVL_05 = 1.75,					--(1.75)
            
    --///AMMO CAPACITY///--
    AMMO_LVL_01 = -1,					--(-1.0) Invalid don't change it. Change WPtype_BaseAmmoNum above instead.
    AMMO_LVL_01_INFO = "9",			    --("9")
    ...
    AMMO_LVL_03 = 11,					--(11)
    AMMO_LVL_03_INFO = "11",			--("11")
    AMMO_LVL_03_COST = 10000,			--(10000)
            
    AMMO_LVL_04 = 12,					--(12)
    AMMO_LVL_04_INFO = "12",			--("12")
    ...
    --///RELOAD SPEED///--
    RELOAD_LVL_01 = 1.20,				--(1.20)
    RELOAD_LVL_01_INFO = "1.20",		--("1.20")
    RELOAD_LVL_01_COST = 0,				--(0)
            
    RELOAD_LVL_02 = 1.30,				--(1.30)
    RELOAD_LVL_02_INFO = "1.30",		--("1.30")
    RELOAD_LVL_02_COST = 7000,			--(7000)
            
    RELOAD_LVL_03 = 1.40,				--(1.40)
    RELOAD_LVL_03_INFO = "1.40",		--("1.40")
    RELOAD_LVL_03_COST = 10000,			--(10000)
            
    RELOAD_LVL_04 = 1.50,				--(1.50)
    RELOAD_LVL_04_INFO = "1.50",		--("1.50")
    RELOAD_LVL_04_COST = 13000,			--(13000)
            
    RELOAD_LVL_05 = 1.60,				--(1.60)
    RELOAD_LVL_05_INFO = "1.60",		--("1.60")
    ...
    ROF_LVL_02 = 1.7,					--(1.7)
    ROF_LVL_02_INFO = "1.33",			--("1.33")
    ROF_LVL_02_COST = 10000,			--(10000)
            
    ROF_LVL_03 = 1.4,					--(1.4)
    ROF_LVL_03_INFO = "1.63",			--("1.63")
    ROF_LVL_03_COST = 14000,			--(14000)
            
    ROF_LVL_04 = 1.2,					--(1.2)
    ROF_LVL_04_INFO = "1.91",			--("1.91")
    ROF_LVL_04_COST = 20000	,			--(20000)
            
    ROF_LVL_05 = 1.0,					--(1.0)
    ROF_LVL_05_INFO = "2.20",			--("2.20")
    ROF_LVL_05_COST = 26000	,			--(26000)
            
        --//////BT Limit Break Stats//////--
