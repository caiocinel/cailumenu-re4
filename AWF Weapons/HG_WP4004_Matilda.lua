--/////////////////////////////////////--
-- Advanced Weapon Framework - VP70 Stats
...
local VP70 = {
    ...
    DMG_LVL_01_INFO = "1.30",			--("1.30")
    DMG_LVL_01_COST = -1,				--(-1)
            
    DMG_LVL_02 = 1.08,					--(1.08)
    DMG_LVL_02_INFO = "1.40",			--("1.40")
    DMG_LVL_02_COST = 15000,			--(15000)
            
    DMG_LVL_03 = 1.23,					--(1.23)
    DMG_LVL_03_INFO = "1.60",			--("1.60")
    DMG_LVL_03_COST = 26000,			--(26000)
            
    DMG_LVL_04 = 1.38,					--(1.38)
    DMG_LVL_04_INFO = "1.80",			--("1.80")
    DMG_LVL_04_COST = 43000,			--(43000)
            
    DMG_LVL_05 = 1.54,					--(1.54)
    DMG_LVL_05_INFO = "2.00",			--("2.00")
    DMG_LVL_05_COST = 62000,			--(62000)
    --///WINCE///--
    ...
    BRK_LVL_02 = 1.16,					--(1.16)
    BRK_LVL_03 = 1.33,					--(1.33)
    BRK_LVL_04 = 1.50,					--(1.50)
    BRK_LVL_05 = 1.66,					--(1.66)
    --///STOPPING POWER///--
    ...
    --///RATE OF FIRE///--
    ROF_LVL_01 = 2.6,					--(2.6)
    ROF_LVL_01_INFO = "0.96",			--("0.96")
    ROF_LVL_01_COST = 0,				--(0)
            
    ROF_LVL_02 = 2.3,					--(2.3)
    ROF_LVL_02_INFO = "1.00",			--("1.00")
    ROF_LVL_02_COST = 10000,			--(10000)
            
    ROF_LVL_03 = 2.0,					--(2.0)
    ROF_LVL_03_INFO = "1.16",			--("1.16")
    ROF_LVL_03_COST = 13000,			--(13000)
            
    ROF_LVL_04 = 1.7,					--(1.7)
    ROF_LVL_04_INFO = "1.33",			--("1.33")
    ROF_LVL_04_COST = 17000	,			--(17000)
            
    ROF_LVL_05 = 1.4,					--(1.4)
    ROF_LVL_05_INFO = "1.63",			--("1.63")
    ROF_LVL_05_COST = 22000	,			--(22000)
            
        --//////VP70 Limit Break Stats//////--
