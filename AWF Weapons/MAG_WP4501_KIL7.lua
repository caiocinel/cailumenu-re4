...
local KIL7 = {
    ...
    HG_CritRate = 6.0,				    --(6.0) Default Critical Rate of the weapon.
    ...
    FireRate = 2.0,					    --(2.0) Base Rate of Fire
    ...
    DMG_LVL_01_INFO = "20.00",			--("20.00")
    DMG_LVL_01_COST = -1,				--(-1)
            
    DMG_LVL_02 = 1.1,					--(1.1)
    DMG_LVL_02_INFO = "22.0",			--("22.0")
    ...
    DMG_LVL_04 = 1.3,					--(1.3)
    DMG_LVL_04_INFO = "26.0",			--("26.0")
    DMG_LVL_04_COST = 60000,			--(47000)
            
    DMG_LVL_05 = 1.4,					--(1.4)
    DMG_LVL_05_INFO = "28.00",			--("28.0")
    DMG_LVL_05_COST = 70000,			--(70000)
    --///WINCE///--
    ...
    AMMO_LVL_04 = 13,					--(13)
    AMMO_LVL_04_INFO = "13",			--("13")
    AMMO_LVL_04_COST = 16000,			--(16000)
            
    AMMO_LVL_05 = 15,					--(15)
    AMMO_LVL_05_INFO = "15",			--("15")
    ...
    --///RATE OF FIRE///--
    ROF_LVL_01 = 2.0,					--(2.0)
    ROF_LVL_01_INFO = "0.81",			--("0.81")
    ROF_LVL_01_COST = 0,				--(0)
            
    ROF_LVL_02 = 1.85,					--(1.85)
    ROF_LVL_02_INFO = "0.88",			--("0.88")
    ROF_LVL_02_COST = 15000,			--(15000)
            
    ROF_LVL_03 = 1.7,					--(1.7)
    ROF_LVL_03_INFO = "0.96",			--("0.96")
    ROF_LVL_03_COST = 20000,			--(20000)
            
    ROF_LVL_04 = 1.55,					--(1.55)
    ROF_LVL_04_INFO = "1.05",			--("1.05")
    ROF_LVL_04_COST = 25000	,			--(25000)
            
    ROF_LVL_05 = 1.4,					--(1.4)
    ROF_LVL_05_INFO = "1.16",			--("1.16")
    ROF_LVL_05_COST = 30000	,			--(30000)
            
        --//////KIL7 Limit Break Stats//////--
